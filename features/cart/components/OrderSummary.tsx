...
export const OrderSummary: React.FC<OrderSummaryProps> = ({
  ...
  return (
    <aside className="w-full lg:w-[380px] space-y-6 lg:sticky lg:top-6">
      <div className="bg-white dark:bg-white/5 rounded-2xl border border-[#e7cfd5] dark:border-white/10 p-5 sm:p-6 shadow-xl shadow-[#ee2b5b]/5">
        <h2 className="typo-heading-md mb-6 border-b border-[#e7cfd5] dark:border-white/10 pb-4">
          Tóm tắt đơn hàng
        </h2>

        <div className="space-y-3 mb-6">
          <div className="flex justify-between items-center typo-caption-xs">
            <span className="text-[#9a4c5f] dark:text-white/60">
          ...
          <div className="pt-4 border-t border-[#e7cfd5] dark:border-white/10 mt-4">
        ...
        {/* Trust points */}
        <div className="mt-6 space-y-3 pt-6 border-t border-[#e7cfd5] dark:border-white/10">
          <div className="flex items-center gap-3 typo-label-sm text-gray-500 dark:text-gray-400">
