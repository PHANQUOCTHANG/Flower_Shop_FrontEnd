        ...
        >
          {otp.map((data, index) => (
            <input
              ...
              className="size-11 sm:size-14 text-center text-2xl font-black border-2 border-slate-100 dark:border-slate-800 rounded-xl focus:border-[#ee2b5b] focus:ring-4 focus:ring-[#ee2b5b]/10 bg-slate-50 dark:bg-transparent outline-none transition-all placeholder:text-slate-300 disabled:opacity-50 disabled:cursor-not-allowed"
              placeholder="·"
            />
          ))}
        </div>
