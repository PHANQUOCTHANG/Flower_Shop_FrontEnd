        ...
        <div className="space-y-2">
          ...
          <div className="relative group">
            ...
            <input
              ...
              className="w-full h-14 pl-12 pr-4 rounded-xl border-2 border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-transparent focus:ring-4 focus:ring-[#ee2b5b]/10 focus:border-[#ee2b5b] outline-none transition-all font-bold disabled:opacity-50 disabled:cursor-not-allowed"
