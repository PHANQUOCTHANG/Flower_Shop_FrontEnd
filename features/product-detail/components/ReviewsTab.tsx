...
export const ReviewsTab: React.FC<ReviewsTabProps> = ({ reviews }) => {
  ...
  return (
    <div className="space-y-8">
      {/* Tổng quát đánh giá */}
      <div className="flex flex-col sm:flex-row items-center gap-8 bg-gray-50 dark:bg-white/5 p-8 rounded-2xl">
        {/* Điểm số */}
        ...
        {/* Nút viết đánh giá */}
        <button className="bg-white dark:bg-[#102216] border border-[#13ec5b] text-[#13ec5b] px-6 py-3 rounded-xl font-bold hover:bg-[#13ec5b] hover:text-[#0d1b12] transition-colors whitespace-nowrap">
          Viết đánh giá
        </button>
      </div>
      ...
      <div className="divide-y divide-gray-100 dark:divide-white/5">
        {reviews.map((rev) => (
          <div key={rev.id} className="py-6">
            ...
            {/* Nội dung */}
            <p className="typo-body text-gray-600 dark:text-gray-300 leading-relaxed">
              {rev.comment}
            </p>
          </div>
        ))}
