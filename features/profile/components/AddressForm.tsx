      ...
      <div className="bg-white rounded-2xl w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-hidden flex flex-col">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-5">
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 rounded-lg border-2 transition-colors text-sm ${
                  errors.name
                    ...
                    : "border-gray-200 bg-white hover:border-gray-300 focus:border-[#EE2B5B] focus:ring-1 focus:ring-[#EE2B5B]"
            ...
            <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg border border-slate-200">
              <input
                ...
                onChange={handleChange}
                disabled={isSubmitting || isLoading}
                className="w-4 h-4 rounded border-gray-300 text-[#EE2B5B] focus:ring-[#EE2B5B] cursor-pointer"
              />
              <label
                htmlFor="isDefault"
        ...
        <div className="flex gap-3 p-6 border-t border-slate-200 bg-slate-50">
          ...
          <button
            ...
            disabled={isSubmitting || isLoading}
            className="flex-1 px-4 py-2.5 bg-[#EE2B5B] text-white rounded-lg font-bold text-sm hover:bg-[#B3163B] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
