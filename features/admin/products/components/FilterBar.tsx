...
export const FilterBar = ({
 ...
 className="w-full pl-12 pr-4 py-2.5 border-none rounded-xl bg-white text-slate-900 placeholder:text-slate-500 text-sm font-medium focus:ring-2 focus:ring-[#13ec5b] transition-all shadow-sm"
 ...
 className="px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-900 text-sm font-medium focus:ring-2 focus:ring-[#13ec5b] transition-all shadow-sm cursor-pointer"
 >
 ...
 className="flex items-center gap-2 px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-900 text-sm font-bold hover:bg-slate-50 active:scale-95 transition-all shadow-sm"
 >
 <X size={16} />
 <span>Xóa lọc</span>
 </button>
 ...
 className="px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-900 text-sm font-medium focus:ring-2 focus:ring-[#13ec5b] transition-all shadow-sm cursor-pointer appearance-none pr-10"
 >
