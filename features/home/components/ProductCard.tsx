...
export default function ProductCard({ product }: ProductCardProps) {
 return (
 <div className="group bg-white rounded-2xl overflow-hidden border border-[#e7f3eb] hover:shadow-xl transition-all duration-300">
 ...
 <h4 className="typo-body text-[#0d1b12] line-clamp-1 mb-1">
 {product.name}
 </h4>
