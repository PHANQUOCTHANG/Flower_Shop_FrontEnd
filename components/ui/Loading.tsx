...
export const Loading = () => {
 return (
 <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#f6f8f6] ">
 <div className="relative">
 {/* Vòng tròn hiệu ứng xung quanh */}
 <div className="absolute inset-0 scale-150 animate-ping rounded-full bg-[#13ec5b]/20"></div>
 
 {/* Biểu tượng hoa xoay */}
 <div className="relative flex items-center justify-center bg-white size-20 rounded-3xl shadow-xl border border-[#13ec5b]/20">
 ...
 <h2 className="text-lg font-black text-slate-900 uppercase tracking-widest">Quốc Thắng</h2>
